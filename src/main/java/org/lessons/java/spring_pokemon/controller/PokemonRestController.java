...
public class PokemonRestController {
    ...
    // @PutMapping("/edit/{id}")
    // public ResponseEntity<Pokemon> update(@Valid @RequestBody Pokemon pokemon, @PathVariable Integer id) {
    ...
    // public ResponseEntity<Pokemon> update(@Valid @RequestBody Pokemon pokemon, @PathVariable String slug) {
